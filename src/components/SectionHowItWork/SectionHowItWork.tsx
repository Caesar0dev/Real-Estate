...
const DEMO_DATA = [
  {
    ...
    desc: "Pour les acquéreurs Avec Tirök, devenir propriétaire est plus simple que jamais.",
  },
  {
    id: 2,
    img: HIW2img,
    imgDark: HIW2img,
    title: "En savoir plus",
    desc: "Pour les investisseurs Avec Tirök, nous avons repensé l'investissement immobilier avec notre modèle économique unique.",
  },
  {
    id: 3,
    img: HIW3img,
    imgDark: HIW3img,
    title: "En savoir plus",
    desc: "Pour les vendeurs Avec Tirök, vendre votre bien immobilier est simple et rapide.",
  },
  {
    id: 4,
    img: HIW4img,
